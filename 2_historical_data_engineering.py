...
def aggregate_data(data):
    ...
    soil_moisture_100_to_255cm_std = []
    ...
    for date in data['daily']['time']:
        ...
        soil_moisture_0_to_7cm_mean.append(df_day['soil_moisture_0_to_7cm'].mean())
        soil_moisture_0_to_7cm_min.append(df_day['soil_moisture_0_to_7cm'].min())
        soil_moisture_0_to_7cm_max.append(df_day['soil_moisture_0_to_7cm'].max())
        soil_moisture_0_to_7cm_std.append(df_day['soil_moisture_0_to_7cm'].std())
        
        soil_moisture_7_to_28cm_mean.append(df_day['soil_moisture_7_to_28cm'].mean())
        soil_moisture_7_to_28cm_min.append(df_day['soil_moisture_7_to_28cm'].min())
        soil_moisture_7_to_28cm_max.append(df_day['soil_moisture_7_to_28cm'].max())
        soil_moisture_7_to_28cm_std.append(df_day['soil_moisture_7_to_28cm'].std())
        
        soil_moisture_28_to_100cm_mean.append(df_day['soil_moisture_28_to_100cm'].mean())
        soil_moisture_28_to_100cm_min.append(df_day['soil_moisture_28_to_100cm'].min())
        soil_moisture_28_to_100cm_max.append(df_day['soil_moisture_28_to_100cm'].max())
        soil_moisture_28_to_100cm_std.append(df_day['soil_moisture_28_to_100cm'].std())
        
        soil_moisture_100_to_255cm_mean.append(df_day['soil_moisture_100_to_255cm'].mean())
        soil_moisture_100_to_255cm_min.append(df_day['soil_moisture_100_to_255cm'].min())
        soil_moisture_100_to_255cm_max.append(df_day['soil_moisture_100_to_255cm'].max())
        soil_moisture_100_to_255cm_std.append(df_day['soil_moisture_100_to_255cm'].std())
        
        soil_temperature_0_to_7cm_mean.append(df_day['soil_temperature_0_to_7cm'].mean())
        soil_temperature_0_to_7cm_min.append(df_day['soil_temperature_0_to_7cm'].min())
        soil_temperature_0_to_7cm_max.append(df_day['soil_temperature_0_to_7cm'].max())
        soil_temperature_0_to_7cm_std.append(df_day['soil_temperature_0_to_7cm'].std())
        
        soil_temperature_7_to_28cm_mean.append(df_day['soil_temperature_7_to_28cm'].mean())
        soil_temperature_7_to_28cm_min.append(df_day['soil_temperature_7_to_28cm'].min())
        soil_temperature_7_to_28cm_max.append(df_day['soil_temperature_7_to_28cm'].max())
        soil_temperature_7_to_28cm_std.append(df_day['soil_temperature_7_to_28cm'].std())
        
        soil_temperature_28_to_100cm_mean.append(df_day['soil_temperature_28_to_100cm'].mean())
        soil_temperature_28_to_100cm_min.append(df_day['soil_temperature_28_to_100cm'].min())
        soil_temperature_28_to_100cm_max.append(df_day['soil_temperature_28_to_100cm'].max())
        soil_temperature_28_to_100cm_std.append(df_day['soil_temperature_28_to_100cm'].std())
        
        soil_temperature_100_to_255cm_mean.append(df_day['soil_temperature_100_to_255cm'].mean())
        soil_temperature_100_to_255cm_min.append(df_day['soil_temperature_100_to_255cm'].min())
        soil_temperature_100_to_255cm_max.append(df_day['soil_temperature_100_to_255cm'].max())
        soil_temperature_100_to_255cm_std.append(df_day['soil_temperature_100_to_255cm'].std())
    ...
    df_result = pd.DataFrame({
        ...
        'soil_moisture_100_to_255cm_min': soil_moisture_100_to_255cm_min,
        'soil_moisture_100_to_255cm_max': soil_moisture_100_to_255cm_max,
        'soil_moisture_100_to_255cm_std': soil_moisture_100_to_255cm_std,
        ...
        'soil_temperature_28_to_100cm_min': soil_temperature_28_to_100cm_min,
        'soil_temperature_28_to_100cm_max': soil_temperature_28_to_100cm_max,
        'soil_temperature_28_to_100cm_std': soil_temperature_28_to_100cm_std,
        'soil_temperature_100_to_255cm_mean': soil_temperature_100_to_255cm_mean,
        'soil_temperature_100_to_255cm_min': soil_temperature_100_to_255cm_min,
        'soil_temperature_100_to_255cm_max': soil_temperature_100_to_255cm_max,
        'soil_temperature_100_to_255cm_std': soil_temperature_100_to_255cm_std,
...
def fetch_weather_data_for_cities(conn, state='Georgia', start_year=1992, end_year=2015):
    ...
    existing_cities = pd.read_sql("SELECT DISTINCT city FROM AggregatedWeatherData", conn)

    # Filter out the existing cities from the cities dataframe
    ...
    for _, row in cities.iterrows():
        ...
        aggregated_data.to_sql('AggregatedWeatherData', conn, if_exists='append', index=False)
...
fetch_weather_data_for_cities(conn, state='Georgia', start_year=2000, end_year=2015)
